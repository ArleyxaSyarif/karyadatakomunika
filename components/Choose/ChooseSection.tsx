                    ...
                    <div className="w-full lg:w-1/2 mb-10">
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className="group p-8 bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-blue-50 transition-all duration-300 flex flex-col gap-5"
                            >
                            ...
                            <motion.div
                                variants={cardVariants}
                                whileHover={{ scale: 1.02 }}
                                className="group p-8 bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-emerald-50 transition-all duration-300 flex flex-col gap-5"
                            >
                                <div className="w-14 h-14 rounded-xl bg-blue-50 flex items-center justify-center group-hover:bg-[#0b50da] transition-colors duration-300">
