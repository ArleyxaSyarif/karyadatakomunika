        ...
        <section className="bg-white text-slate-900 py-20 lg:py-32">
            <div className="max-w-7xl mx-auto px-6 w-full">
                ...
                <div className="text-center mb-16 max-w-2xl mx-auto">
                    <span className="text-[#0b50da] font-bold tracking-widest text-xs uppercase mb-3 block">
                        Enterprise Excellence
                    </span>
                    <h2 className="text-slate-900 text-4xl md:text-5xl font-black mb-4 tracking-tight">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 w-full">
                    ...
                    <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 flex flex-col items-center text-center group hover:shadow-xl hover:shadow-blue-50 transition-all duration-300">
                    ...
                    <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 flex flex-col items-center text-center group hover:shadow-xl hover:shadow-emerald-50 transition-all duration-300">
                        <div className="relative size-32 mb-6">
                            <svg className="size-full -rotate-90" viewBox="0 0 36 36">
                                <circle className="stroke-slate-200" cx="18" cy="18" fill="none" r="16" strokeWidth="3"></circle>
                                <circle
                    ...
                    <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 flex flex-col justify-between group hover:shadow-xl hover:shadow-blue-50 transition-all duration-300">
                        <div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="w-full bg-slate-200 h-2 rounded-full overflow-hidden">
                                <div className="bg-gradient-to-r from-[#0b50da] to-blue-400 h-full w-[88%] rounded-full"></div>
                            </div>
                        </div>
                    </div>

                    {/* Linear Metric 2: Partners */}
                    <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 flex flex-col justify-between group hover:shadow-xl hover:shadow-emerald-50 transition-all duration-300">
                        <div>
                            <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="w-full bg-slate-200 h-2 rounded-full overflow-hidden">
                                <div className="bg-gradient-to-r from-[#10b981] to-teal-400 h-full w-[75%] rounded-full"></div>
                            </div>
                        </div>
                    </div>
