                    ...
                    <div className="space-y-8">
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className="group flex items-start gap-4 p-4 rounded-2xl transition-all duration-300 hover:bg-slate-50 hover:shadow-sm border border-transparent hover:border-slate-100"
                            >
