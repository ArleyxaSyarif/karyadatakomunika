      ...
      <main className="flex flex-col items-center justify-center py-20 px-6 lg:px-10">
        <div className="max-w-6xl w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Vision Card */}
            <div className="group relative flex flex-col p-8 md:p-12 rounded-xl bg-white border border-slate-200 shadow-sm hover:shadow-xl hover:border-[#137fec]/30 transition-all duration-300">
            ...
            {/* Mission Card */}
            <div className="group relative flex flex-col p-8 md:p-12 rounded-xl bg-white border border-slate-200 shadow-sm hover:shadow-xl hover:border-[#22c55e]/30 transition-all duration-300">
              <div className="absolute top-0 right-0 p-4">
