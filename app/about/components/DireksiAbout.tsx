    ...
    <>
      ...
      <style dangerouslySetInnerHTML={{
        ...
        .pattern-bg {
          ...
          background-image: url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23137fec' fill-opacity='0.03'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E");
        }
        .dark .pattern-bg {
        ...
        @keyframes infinite-scroll {
          ...
          to { transform: translateX(-50%); } /* Diubah ke -50% karena kita menduplikasi 1 set data */
        }
      ...
      <div className={`${inter.className} bg-[#f6f7f8] dark:bg-[#101922] text-slate-900 dark:text-slate-100 pattern-bg min-h-screen w-full flex-col overflow-x-hidden flex`}>
        <main className="layout-container flex grow flex-col pt-10">
          ...
          <section className="flex flex-col items-center justify-center px-6 py-20 text-center lg:px-40">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-blue-50 px-3 py-1 text-xs font-bold uppercase tracking-wider text-[#137fec] ring-1 ring-inset ring-blue-100 dark:bg-blue-900/20 dark:ring-blue-900/40">
              <span className="h-2 w-2 rounded-full bg-[#10b981]"></span>
              Our Governance
            </div>
            <h1 className="mb-6 max-w-3xl text-4xl font-black leading-tight tracking-tight text-slate-900 dark:text-white md:text-5xl lg:text-6xl">
              Visionary Leadership <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#137fec] to-blue-400">Guiding Our Future</span>
            </h1>
          ...
          <div className="mx-auto w-full max-w-[1200px] px-6 pb-24">
            ...
            <div className="mb-12 flex items-center gap-4">
              <h2 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Board of Directors</h2>
            ...
            <div className="flex flex-col gap-12">
              {/* CEO: Sarah Jenkins */}
              <div className="group relative overflow-hidden rounded-3xl bg-white p-2 shadow-xl shadow-slate-200/50 ring-1 ring-slate-100 transition-all hover:shadow-2xl hover:shadow-blue-500/10 dark:bg-slate-800 dark:shadow-none dark:ring-slate-700">
                <div className="flex flex-col gap-8 md:flex-row">
                  <div className="relative h-64 w-full shrink-0 overflow-hidden rounded-2xl md:h-auto md:w-1/3 lg:w-[320px]">
                    ...
                    <div className="h-full w-full bg-cover bg-center transition-transform duration-700 group-hover:scale-105" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuD70TNUU4KpCclDP_bK7DsIgk_fdI92wrS-4lsnTD50zl1tjU8NC3MD53OivAlK7O0pEwmta-qYobbO0AUuv5abQkdDjTKL1_C0gkyLup9SgYcpPINv0GZpJpaoib44bR7s4uGmJynadk8sPqgWt1ptNQ9DsorgbvVE-iy4GAf_nGHRLVtT0FkDcRMLc66BbXPsHE9hIYipuYI_4jnocmP9LAJPUe3qjDUiU7DVyQlbTmJwteKPOkk89qKwXRUKaH457ChM8k5cp6le')" }}></div>
                    <div className="absolute bottom-4 left-4 z-20 flex gap-2 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      <a className="flex size-8 items-center justify-center rounded-full bg-white/20 text-white backdrop-blur-md hover:bg-white hover:text-[#137fec]" href="#">
                  ...
                  <div className="flex flex-1 flex-col justify-center px-4 pb-6 md:py-8 md:pr-10">
                    <div className="mb-4 flex items-start justify-between">
                      <div>
                        ...
                        <p className="text-[#137fec] font-medium">Chief Executive Officer</p>
                      </div>
                      <div className="hidden h-10 w-10 items-center justify-center rounded-full bg-blue-50 text-[#137fec] dark:bg-blue-900/20 sm:flex">
                    ...
                    <div className="mt-auto flex items-center justify-between border-t border-slate-100 pt-6 dark:border-slate-700">
                      ...
                      <button className="group/btn flex items-center gap-2 text-sm font-bold text-slate-900 transition-colors hover:text-[#137fec] dark:text-white dark:hover:text-[#137fec]">
              ...
              <div className="group relative overflow-hidden rounded-3xl bg-white p-2 shadow-xl shadow-slate-200/50 ring-1 ring-slate-100 transition-all hover:shadow-2xl hover:shadow-blue-500/10 dark:bg-slate-800 dark:shadow-none dark:ring-slate-700">
                <div className="flex flex-col gap-8 md:flex-row-reverse">
                  <div className="relative h-64 w-full shrink-0 overflow-hidden rounded-2xl md:h-auto md:w-1/3 lg:w-[320px]">
                    <div className="absolute inset-0 z-10 bg-gradient-to-t from-slate-900/40 to-transparent"></div>
                    <div className="h-full w-full bg-cover bg-center transition-transform duration-700 group-hover:scale-105" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCwKL70JVpEb4PeZj9jqb4jV_gG8piqcfx6He2Azg1EZVRD63pqSYba_jUp926H2GHow47Z-yycuztyn6Ujmgy_apR3aPbINH8zc-DeIIMd-d4no2Eh1DybX1mTC0caPZkF22Qd3J3tnfujOefUuWpR6v-uuMRXxEnh8wnDZt9SU2JNsaUfsIIaQqkTCciZz0MvpZHRdwjLEsVjCAE_fC5JzjruAjtBFJOlTiWEXGYJiRgd1GUAmJ74FZUmlMp5H4PWG8B2i7hPaDmJ')" }}></div>
                  ...
                  <div className="flex flex-1 flex-col justify-center px-4 pb-6 md:py-8 md:pl-10 text-right md:text-right">
                    <div className="mb-4 flex flex-row-reverse items-start justify-between">
                      <div>
                        <h3 className="text-2xl font-bold text-slate-900 dark:text-white">David Chen</h3>
                        <p className="text-[#137fec] font-medium">Chief Technology Officer</p>
                      </div>
                      <div className="hidden h-10 w-10 items-center justify-center rounded-full bg-blue-50 text-[#137fec] dark:bg-blue-900/20 sm:flex">
                        <span className="material-symbols-outlined">code</span>
                      </div>
                    </div>
                    <p className="mb-6 text-base leading-relaxed text-slate-600 dark:text-slate-300 md:ml-auto">
                    ...
                    <div className="mt-auto flex flex-row-reverse items-center justify-between border-t border-slate-100 pt-6 dark:border-slate-700">
                      <div className="flex gap-4 text-sm text-slate-500 dark:text-slate-400">
                      ...
                      <button className="group/btn flex items-center gap-2 text-sm font-bold text-slate-900 transition-colors hover:text-[#137fec] dark:text-white dark:hover:text-[#137fec] flex-row-reverse">
              ...
              <div className="group relative overflow-hidden rounded-3xl bg-white p-2 shadow-xl shadow-slate-200/50 ring-1 ring-slate-100 transition-all hover:shadow-2xl hover:shadow-blue-500/10 dark:bg-slate-800 dark:shadow-none dark:ring-slate-700">
                <div className="flex flex-col gap-8 md:flex-row">
                  <div className="relative h-64 w-full shrink-0 overflow-hidden rounded-2xl md:h-auto md:w-1/3 lg:w-[320px]">
                    <div className="absolute inset-0 z-10 bg-gradient-to-t from-slate-900/40 to-transparent"></div>
                    <div className="h-full w-full bg-cover bg-center transition-transform duration-700 group-hover:scale-105" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCgTSS83ZMvC-j-FtF1fb828fmNc9SetoBiqQFTtNQ7JndXy_W5h1ZbeYTGSCMYz84V6rAKXsM3KQSRJP_hYx9Ma5PVvFf2R_9S4k2xkLUStS0xvCRWQzTrv63GnljpwpgI--5r8sLxG5Ul47-XGZONPr6aRuXbODMalBSy_jbDsclb6PpslwuzUeLjTwxouHR_Jk9ITc2r4xEKMR_UQY48HktC65mNXFx6lmfc_Aky0ZfWZIe-JaWNE4msFhqMJ9qrZ64mpOj0Am4I')" }}></div>
                    <div className="absolute bottom-4 left-4 z-20 flex gap-2 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      <a className="flex size-8 items-center justify-center rounded-full bg-white/20 text-white backdrop-blur-md hover:bg-white hover:text-[#137fec]" href="#">
                        <span className="material-symbols-outlined text-sm">mail</span>
                      </a>
                  ...
                  <div className="flex flex-1 flex-col justify-center px-4 pb-6 md:py-8 md:pr-10">
                    <div className="mb-4 flex items-start justify-between">
                      <div>
                        <h3 className="text-2xl font-bold text-slate-900 dark:text-white">Elena Rodriguez</h3>
                        <p className="text-[#137fec] font-medium">Chief Financial Officer</p>
                      </div>
                      <div className="hidden h-10 w-10 items-center justify-center rounded-full bg-blue-50 text-[#137fec] dark:bg-blue-900/20 sm:flex">
            ...
            <div className="mt-24 mb-12 flex items-center gap-4">
              <h2 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Board of Commissioners</h2>
              <div className="h-[2px] flex-1 bg-gradient-to-r from-[#10b981] to-transparent opacity-50"></div>
            </div>
              ...
              <div className="flex w-max animate-infinite-scroll hover:[animation-play-state:paused] py-4">
                ...
                {[...commissioners, ...commissioners].map((person, index) => (
                  <div key={index} className="w-[300px] shrink-0 px-3">
                    <div className="group h-full rounded-2xl bg-white p-6 shadow-lg shadow-slate-200/50 ring-1 ring-slate-100 transition-all hover:-translate-y-1 hover:shadow-xl hover:ring-[#137fec]/20 dark:bg-slate-800 dark:shadow-none dark:ring-slate-700">
                      <div className="mb-4 flex items-center gap-4">
                        
                        {/* Avatar Image atau Placeholder Icon */}
                        {person.imgSrc ? (
                          <div className="h-16 w-16 overflow-hidden rounded-full ring-2 ring-white shadow-md dark:ring-slate-700">
                            <div className="h-full w-full bg-cover bg-center" style={{ backgroundImage: `url('${person.imgSrc}')` }}></div>
                          </div>
                        ) : (
                          <div className="flex h-16 w-16 items-center justify-center overflow-hidden rounded-full bg-slate-100 ring-2 ring-white shadow-md dark:bg-slate-700 dark:ring-slate-700">
                            <span className="material-symbols-outlined text-3xl text-slate-400">person</span>
                          </div>
                        )}

                        <div>
                          <h4 className="text-lg font-bold text-slate-900 dark:text-white">{person.name}</h4>
                      ...
                      <a className="inline-flex items-center text-xs font-bold uppercase tracking-wider text-[#137fec] hover:text-[#0b5cb5]" href="#">
        ...
        <footer className="bg-white border-t border-slate-200 py-10 dark:bg-slate-900 dark:border-slate-800 mt-auto">
          <div className="layout-container px-6 lg:px-40 text-center">
            <p className="text-sm text-slate-500 dark:text-slate-400">© 2024 Corporate Co. All rights reserved.</p>
          </div>
        </footer>
      </div>
    </>
